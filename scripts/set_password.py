...
fresh device used to mean opening a long tokenised URL — fine on a
desktop, painful on a phone, and broken on iOS PWAs whose
localStorage is partitioned from Safari's main jar.
