# Run the Playwright smoke suite against a live tray on https://127.0.0.1:8444.
...
#
# If the tray isn't up, conftest.py's autoboot fallback boots its own
# disposable instance instead.
...
# Explicit live-tray opt-in (issue #108): this script IS the deliberate
