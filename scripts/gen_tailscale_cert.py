...
def main() -> None:
    ...
    print(f"  https://{hostname}:8444")
    print()
    print("Note: https://localhost:8444 will show a cert hostname-mismatch warning")
    print("because this cert is issued only for the Tailscale domain.")
    print("Use http://localhost:8444 for plain local desktop access.")
