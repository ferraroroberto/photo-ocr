...
MOBILECONFIG_FILENAME = "photo-ocr-ca.mobileconfig"

CA_COMMON_NAME = "Photo OCR Local CA"
CA_ORG = "Photo OCR"
...
def main() -> int:
    ...
    logger.info("   • iOS: open  https://<host>:8444/install-ca")
...
def _build_leaf(ca_key, ca_cert, hostnames: Set[str], ips: Set[ipaddress.IPv4Address]):
    key = rsa.generate_private_key(public_exponent=65537, key_size=2048)
    subject = x509.Name([
        x509.NameAttribute(NameOID.COMMON_NAME, "photo-ocr.local"),
        x509.NameAttribute(NameOID.ORGANIZATION_NAME, CA_ORG),
    ])
...
<dict>
    ...
    <array>
        <dict>
            ...
            <string>photo-ocr-ca.cer</string>
            <key>PayloadContent</key>
            <data>
{cert_b64_chunks}
            </data>
            <key>PayloadDescription</key>
            <string>Adds the Photo OCR local CA to the iOS trust store.</string>
            <key>PayloadDisplayName</key>
            <string>{CA_COMMON_NAME}</string>
            <key>PayloadIdentifier</key>
            <string>com.photoocr.localca.cert.{payload_uuid}</string>
            <key>PayloadType</key>
    ...
    <key>PayloadDescription</key>
    <string>Trust profile for self-signed Photo OCR webapp on this LAN.</string>
    <key>PayloadDisplayName</key>
    <string>Photo OCR Trust</string>
    <key>PayloadIdentifier</key>
    <string>com.photoocr.localca.profile.{profile_uuid}</string>
