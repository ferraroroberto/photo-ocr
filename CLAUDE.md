...
- **Pre-ship gate:** any change under `app/webapp/` (or the webapp-facing `src/` modules) must pass `pwsh -File scripts/verify-before-ship.ps1` before it is declared done.
